...
> Possíveis abordagens: (a) tabela única com campos opcionais, (b) tabela genérica com FK para entidades específicas, (c) duas tabelas independentes. Você deve escolher e justificar com base em integridade, normalização e flexibilidade.
...
**RF06 + RF07. Registro de Movimentações Financeiras (Receitas e Despesas)**
O sistema deve permitir o registro de **movimentações financeiras** do usuário. Cada movimentação possui:
...
> Você deve escolher e justificar.

**RF06.1 + RF07.1. Movimentações Recorrentes**
...
>
> Você deve decidir se incluirá essa entidade e justificar com base no perfil do público-alvo e nos requisitos do sistema.

### 3.5 Orçamentos

**RF08. Orçamentos Mensais**
...
>
> Você deve decidir qual abordagem adotar e justificar.

### 3.6 Metas Financeiras

**RF09. Metas de Economia/Investimento**
...
**RF10. Consulta de Saldo por Período**
...
- **RF13.3**: notificação de **orçamento estourado** quando o total de despesas no escopo do orçamento (geral ou por categoria, conforme decisão dVocê no dilema #4) ultrapassa o valor limite definido, dentro do período do orçamento.
...
| 5 | Aplicar soft-delete? Em quais tabelas? | Decisão livre, com justificativa. |
